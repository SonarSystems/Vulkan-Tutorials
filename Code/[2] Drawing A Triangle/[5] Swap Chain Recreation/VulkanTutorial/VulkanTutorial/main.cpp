...
private:
	...
	*
	* Track if the frame buffer has been resized
	*/
	...
	*/
	...
	void InitWindow( )
	{
		...
		/**
		* \brief START OF OLD CODE REMOVAL
		*
		* Remove as we are now making the window resizable
		*/
		//glfwWindowHint( GLFW_RESIZABLE, GLFW_FALSE );
		/**
		* \brief END OF OLD CODE REMOVAL
		*/
		...
		* and call the framebuffer resize callback
		*/
	...
	*/
	...
	void Cleanup( )
	{
		...
		* \brief START OF NEW CODE ADDED
		*
		* Call the cleanup swapchain method
		*/
		CleanupSwapChain( );
		/**
		* \brief END OF NEW CODE ADDED
		...
		* \brief START OF OLD CODE REMOVAL
		*
		* Remove as we have abstracted it now
		*/
		/*for ( auto framebuffer : _swapChainFrameBuffers )
		{
			vkDestroyFramebuffer( _device, framebuffer, nullptr );
	...
	*/
	void RecreateSwapChain( )
	{
		...
		// Get the frame buffer size based on the current window size
		glfwGetFramebufferSize( _window, &width, &height );

		// Check if window has been minimized (can be detected by checking if swap chain)
		// is out of data which is considered a window resize
		...
		// Wait for the device until maximised again
		vkDeviceWaitIdle( _device );

		// Cleanup the swapchain
		CleanupSwapChain( );

		// Go through the recreation process again
		CreateSwapChain( );
		CreateImageViews( );
		CreateRenderPass( );
		CreateGraphicsPipeline( );
		...
		// Match images in flight vector size to the swap chain images size
	...
	*/
	...
	void DrawFrame( )
	{
		...
		/**
		* \brief START OF CODE UPDATE
		*
		* Get the result to check in the if statement below if the swap chain needs updating
		*/
		...
		/**
		* \brief END OF CODE UPDATE
		*/

		/**
		* \brief START OF NEW CODE ADDED
		*
		* See if the swap chain needs to be recreated and recreate it if need be
		*/
		...
		*
		* See if the swap chain needs to be recreated and recreate it if need be
		* Recreated if the swap chain is suboptimal
		*/
