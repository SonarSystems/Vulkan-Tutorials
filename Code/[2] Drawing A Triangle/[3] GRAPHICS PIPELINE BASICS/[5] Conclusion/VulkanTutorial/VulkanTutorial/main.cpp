...
private:
	...
	*/
	...
	void CreateGraphicsPipeline( )
	{
		...
		* \brief START OF NEW CODE ADDED
		*
		* Time to create the graphics pipeline (we will combine the shader stages, fixed function state, pipeline layout and render pass)
		*/
		...
		// We first reference all the create info structs previously created
		...
		// Setting the render pass
		pipelineInfo.renderPass = _renderPass;
		pipelineInfo.subpass = 0;
		// Specify a null pipeline handle as we are only using a single pipeline
		pipelineInfo.basePipelineHandle = VK_NULL_HANDLE;

		// Try creating the graphics pipeline
